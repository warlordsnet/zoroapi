...
type CommonAnimeProps = "id" | "name" | "jname" | "poster";
...
export interface TrendingAnime extends Pick<Anime, CommonAnimeProps>, Pick<Top10Anime, "rank"> {
}
...
export interface AnimeGeneralAboutInfo extends Pick<Anime, CommonAnimeProps>, Pick<SpotlightAnime, "description"> {
    stats: {
        quality: string | null;
...
export type AnimeServers = "vidstreaming" | "megacloud" | "streamsb" | "streamtape" | "vidcloud";
